//   SSRSDeployerTool / GetReportLinkCompletedEventArgs.cs
// ------------------------------------------------------------------
...
namespace SSRSDeployerTool.SSRSWebService
{
    ...
    public partial class GetReportLinkCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs
    {
        ...
        internal GetReportLinkCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : base(exception, cancelled, userState)
        {
