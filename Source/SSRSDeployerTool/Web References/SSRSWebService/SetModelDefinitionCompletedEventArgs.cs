//   SSRSDeployerTool / SetModelDefinitionCompletedEventArgs.cs
// ------------------------------------------------------------------
...
namespace SSRSDeployerTool.SSRSWebService
{
    ...
    public partial class SetModelDefinitionCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs
    {
        ...
        internal SetModelDefinitionCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : base(exception, cancelled, userState)
        {
