//   SSRSDeployerTool / ListReportHistoryCompletedEventArgs.cs
// ------------------------------------------------------------------
...
namespace SSRSDeployerTool.SSRSWebService
{
    ...
    public partial class ListReportHistoryCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs
    {
        ...
        internal ListReportHistoryCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : base(exception, cancelled, userState)
        {
